...
pub fn one(conn: &mut PooledConn, slug: &str) -> Result<Option<Category>, Error> {
    categories::table
...
pub fn many(conn: &mut PooledConn) -> Result<Vec<Category>, Error> {
    categories::table
        .order_by(categories::slug.desc())
        .load::<Category>(conn)
}

pub fn insert(conn: &mut PooledConn, tag: Category) -> Result<Category, Error> {
...
pub fn update(conn: &mut PooledConn, slug: &str, tag: &str) -> Result<Option<Category>, Error> {
...
pub fn delete(conn: &mut PooledConn, slug: &str) -> Result<Option<Category>, Error> {
